"""
CNN+LSTM 3-Feature Fusion (3FF) Model
Fuses Spectrogram + MFCC + F0 features for audio classification
"""
import torch
...
class CNNLSTM_3FF(nn.Module):
    """
    3-Feature Fusion Network: Spectrogram + MFCC + F0
    ...
    def __init__(
        ...
        # Fusion classifier
        fused_dim = branch_output_dim * 3  # Concatenate 3 branches
    ...
    def get_features(self, spec, mfcc, f0):
        ...
        Returns:
            features: [batch, branch_output_dim*3] - Fused features
        """
...
def create_cnnlstm_3ff(
    ...
    """
    Create a CNN+LSTM 3-Feature Fusion model with default settings
    ...
    Returns:
        model: CNNLSTM_3FF model instance
    """
    return CNNLSTM_3FF(
...
if __name__ == "__main__":
    ...
    print("=" * 60)
    print("CNN+LSTM 3-Feature Fusion Model Test")
    print("=" * 60)
